...
namespace LuxeLooks.DataManagment.Migrations
{
    ...
    [Migration("20231009113445_Added Categories")]
            ...
            modelBuilder.Entity("LuxeLooks.Domain.Entity.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f4b1f52-39e8-4b2e-953a-dfb91dd7c0d6"),
                        ...
                        new
                        {
                            Id = new Guid("49ca435e-6578-44aa-a2bb-9a1b833372ca"),
                        ...
                        new
                        {
                            Id = new Guid("ff489025-6bcd-406c-8e5a-519e07a27e2d"),
                        ...
                        new
                        {
                            Id = new Guid("bf2597c4-2b3c-415d-8540-5609a9a5cded"),
                        ...
                        new
                        {
                            Id = new Guid("c6f10de3-7aef-4792-b41f-bc8fc16604d4"),
                        ...
                        new
                        {
                            Id = new Guid("1dd11197-b7a6-4088-b9d0-ea6132bfa3f5"),
                        ...
                        new
                        {
                            Id = new Guid("138d569b-9765-4f17-bdec-3493fee8b8be"),
                        ...
                        new
                        {
                            Id = new Guid("4ba107b6-7a2f-4193-83ee-6a946c21367f"),
                        ...
                        new
                        {
                            Id = new Guid("45cebd9f-d6dc-4def-acc8-0a4e55faec55"),
            ...
            modelBuilder.Entity("LuxeLooks.Domain.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b3ee6ca1-af23-41a9-b567-4d765550c885"),
                        ...
                        new
                        {
                            Id = new Guid("aadf6762-cad2-4e99-92d3-cafbd29be46f"),
                        ...
                        new
                        {
                            Id = new Guid("1bfac646-a474-43d1-b1c0-466793c03e47"),
                        ...
                        new
                        {
                            Id = new Guid("46c43469-397e-4cbe-9ef4-7412e9c78de1"),
                        ...
                        new
                        {
                            Id = new Guid("6c58d5fd-1ba1-47ba-83c9-c7ffc9e2870b"),
                        ...
                        new
                        {
                            Id = new Guid("6c9a09e7-9489-4bb7-84ec-ac03e6f451f8"),
                        ...
                        new
                        {
                            Id = new Guid("f46abe55-e6f7-4663-9fbd-a1a1f82e8011"),
                        ...
                        new
                        {
                            Id = new Guid("74c77e86-3df2-4425-99d9-f7e3eace11ba"),
                        ...
                        new
                        {
                            Id = new Guid("364a121b-194f-4daf-a1e2-17e2e9a163f0"),
                        ...
                        new
                        {
                            Id = new Guid("7b1aded0-d7a4-4280-b9d6-8561891b47ab"),
                        ...
                        new
                        {
                            Id = new Guid("0a5e6ae6-f534-4cfb-a60f-e23b6f8967e3"),
                        ...
                        new
                        {
                            Id = new Guid("b48fb129-ad41-4a05-9403-17849026cf4c"),
                        ...
                        new
                        {
                            Id = new Guid("750d0c07-ccfd-487c-a2b8-2f570d2d2d64"),
                        ...
                        new
                        {
                            Id = new Guid("4d01e46f-29ad-416c-8e79-2db92e70ed3d"),
            ...
            modelBuilder.Entity("LuxeLooks.Domain.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("f272aa8d-d1f8-452e-9a7b-7c8153fa2885"),
            ...
            modelBuilder.Entity("LuxeLooks.Domain.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f8bbdeb1-d7a0-4dad-b602-eafbfa212dd8"),
                            Email = "alsemkovbn@gmail.com",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "$2a$12$YElrO3v7oUhcsyczDWGfs./TrcQxQELkwenyhau6of9NvrbGqdoIm",
                            PasswordSalt = "$2a$12$YElrO3v7oUhcsyczDWGfs.",
                            RefreshTokenExpiryTime = new DateTime(2023, 10, 9, 11, 34, 45, 542, DateTimeKind.Utc).AddTicks(4920),
