...
public static class JwtTokenExtension
{
    ...
    public static JwtSecurityToken CreateToken(this IConfiguration configuration, List<Claim> authClaims)
    {
        ...
        var tokenValidityInDaysString = configuration.GetSection("Jwt:TokenValidityInDays").Value;
        int.TryParse(tokenValidityInDaysString, out int tokenValidityInDays);
